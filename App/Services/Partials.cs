...
public static class Partials
{
    ...
    {
        public const string Video = "Item/_Video";
        public const string User = "Item/_User";
    }
    ...
    public static class Views
    {
        ...
        public const string Error = "Views/_Error";
    }

    public static class Page
    {
        public const string Header = "Page/_Header";
        public const string Sidebar = "Page/_Sidebar";
    }

    public static class Part
    {
        public const string Background = "Part/_Background";
        public const string Title = "Part/_Title";
        public const string UserPageHeader = "Part/_UserPageHeader";
        public const string Feed = "Part/_Feed";
        public const string TailwindContainer = "Part/_TailwindContainer";
    }

    public static class Backgrounds
    {
        public const string Bookmark = "FontAwesome/_Bookmark";
        ...
        public const string Error = "FontAwesome/_Error";
    }
}